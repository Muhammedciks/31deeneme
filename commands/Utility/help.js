...
client.emoji("🎃"),
    ...
    let button = new MessageActionRow().addComponents(
      new client.Discord.MessageButton()
        .setURL("https://discord.gg/M5Zd2SSdr9")
        .setStyle("LINK")
        .setEmoji("🧑‍🦯")
        .setLabel("Support"),
      new client.Discord.MessageButton()
        .setURL("https://discord.com/api/oauth2/authorize?client_id=896337631137394728&permissions=34362904128&scope=bot%20applications.commands")
        .setStyle("LINK")
        .setEmoji("🌻")
        .setLabel("Invite Me")
    );
